...
import { deleteUserFailure, deleteUserStart, deleteUserSuccess, signOutUserStart, updateUserStart, updateUserSuccess,updateUserfailure } from '../redux/user/userSlice';
        ...
        <h1 className='text-center mt-7 text-2xl font-semibold'>Your Listings</h1>
         {userListings.map((listing)=>(
            <div key={listing._id} className='border gap-4 rounded-lg p-3 flex justify-between items-center'>
                ...
                <Link className='flex-1 text-slate-700  hover:underline truncate font-semibold' to = {`/listing/${listing._id}`}>
