           ...
           <p className='text-center'>
            {
                fileUploadError ? (
                    ...
                    <span className='text-yellow-500'>Image successfully uploaded</span>
                ) : (
                    ''
                )
            }
            ...
            <input type="email" placeholder='email' defaultValue={currentUser.email } onChange={handleChange} id="username" id="email" className='border p-3 rounded-lg '/>
            <input type="text" placeholder='password' onChange={handleChange} id="password" className='border p-3 rounded-lg '/>
